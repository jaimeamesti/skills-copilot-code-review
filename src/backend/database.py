...
# Example announcements - will be seeded in the database
# Dates are set relative to the current date
initial_announcements = [
    {
        "message": "📢 Activity registration is open! Sign up for your favorite extracurricular activities today. Limited spots available for some activities.",
